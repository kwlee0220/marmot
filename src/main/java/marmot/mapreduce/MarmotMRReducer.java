 ...
 */
public class MarmotMRReducer extends Reducer<Writable, RecordWritable, Writable, Writable>
								implements MarmotReducerContext {
	private static final Logger s_logger = LoggerFactory.getLogger(MarmotMRReducer.class);
	...
	public void run(Context context) throws IOException, InterruptedException {
		...
		try {	
			m_plan = MapReduceStage.getReducerPlan(conf);
			...
			if ( s_logger.isInfoEnabled() ) {
				s_logger.info("plan for reducer: " + m_plan.getName());
