 ...
 */
public class Min implements ValueAggregate {
	private static final String DEFAULT_OUT_COLUMN = "min";
	...
	public void aggregate(Record accum, Record intermediate) {
		Object min = accum.get(m_intermColIdx);
		Object data = intermediate.get(m_intermColIdx);
		if ( min == null || ((Comparable<Object>)min).compareTo(data) > 0 ) {
